...
<section class="page-container">
    <div class="container">
        <div class="content-card text-center">
            ...
            $sql = "SELECT SUM(paid_fees) AS total_amount FROM transaction";
            $res = mysqli_query($conn, $sql) or die(mysqli_error($conn));
            $row = mysqli_fetch_assoc($res);
            $total_amount = round($row['total_amount']*(10/100));
            ?>
            <h1 class="display-5 fw-bold mb-3" id="page-heading">BDT <?php echo $total_amount; ?></h1>
            <p class="lead text-muted" id="page-tagline">All active transaction where you get profit.</p>
        </div>
        ...
        <div class="content-card">
            <div class="d-flex justify-content-between">
                <div>
                    <h3 class="section-header" id="cases-table-heading">Profit List</h3>
                </div>
                <div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tr>
                        ...
                        <th scope="col" id="col-billed-amount">Profit (10%)</th>
                    </tr>
                    </thead>
                    <?php
                        ...
                        if (mysqli_num_rows($res) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        echo "BDT ".round($row['paid_fees']*(10/100));
                                        ?></td>
                                </tr>
                                <?php
                                $count +=1;
                            ...
                            echo '<tr style="text-align: center;font-weight: bolder;color:red;"><td>No data found yet !</td> </tr>';
                        }
                        ?>
                        </tbody>
