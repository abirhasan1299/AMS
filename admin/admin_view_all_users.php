...
<head>
    ...
    <title>View All Users - Advocate & Criminology Management System - আইনপ্রহরী</title>
    ...
    <main class="dashboard-container">
        <div class="container">
            <div class="content-card">
                <div class="row">
                    <div class="col-md-8">
                        <h2 class="section-header" id="header-users">All Users</h2>
