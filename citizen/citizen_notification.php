...
<head>
    ...
    <title>Notifications - Advocate & Criminology Management System - আইনপ্রহরী</title>
    ...
    <section class="main-content-container">
        <div class="container">
            <div class="info-card text-center">
                <h1 class="display-5 fw-bold mb-3" id="page-heading">বিজ্ঞপ্তি</h1>
                <p class="lead text-muted mb-4" id="page-description">মামলার আপডেট, অ্যাপয়েন্টমেন্ট এবং সিস্টেম সতর্কতা সম্পর্কে অবগত থাকুন।</p>
            </div>
                    ...
                    <div class="info-card">
                        ...
                        <div id="notification-list">
                            <div class="notification-item unread" id="notification-1">
                                ...
                                <div class="content">
                                    <h6 id="notification-title-1">নতুন কেস আপডেট: মামলা #CRN-12345</h6>
                                    <p id="notification-text-1">আপনার মামলার স্থিতি 'তদন্তাধীন' থেকে 'শুনানির জন্য নির্ধারিত' এ পরিবর্তিত হয়েছে।</p>
                                </div>
                            ...
                            <div class="notification-item unread" id="notification-2">
                                ...
                                <div class="content">
                                    <h6 id="notification-title-2">নতুন পরামর্শ অ্যাপয়েন্টমেন্ট</h6>
                                    <p id="notification-text-2">অ্যাডভোকেট জাহিদ হাসানের সাথে আপনার পরামর্শ 2025-07-22 তারিখে 10:00 AM এ নির্ধারিত হয়েছে।</p>
                                </div>
                            ...
                            <div class="notification-item" id="notification-3">
                                ...
                                <div class="content">
                                    <h6 id="notification-title-3">নতুন নথি আপলোড</h6>
                                    <p id="notification-text-3">আপনার আইনজীবী মামলা #CRN-12345 এর জন্য একটি নতুন নথি আপলোড করেছেন।</p>
                                </div>
                            ...
                            <div class="notification-item" id="notification-4">
                                ...
                                <div class="content">
                                    <h6 id="notification-title-4">সিস্টেম রক্ষণাবেক্ষণ সতর্কতা</h6>
                                    <p id="notification-text-4">সিস্টেমটি 2025-07-25 তারিখে 2:00 AM থেকে 4:00 AM পর্যন্ত রক্ষণাবেক্ষণের জন্য বন্ধ থাকবে।</p>
                                </div>
            ...
            const content = {
                en: {
                    ...
                    page: {
                        ...
                        description: "Stay informed about case updates, appointments, and system alerts.",
                        notificationCenterHeading: "Notification Center",
                        notificationTitle1: "New Case Update: Case #CRN-12345",
                        notificationText1: "Your case status has changed from 'Investigating' to 'Scheduled for Hearing'.",
                        notificationTime1: "5 minutes ago",
                        markAsRead: "Mark as Read",
                        notificationTitle2: "New Consultation Appointment",
                        notificationText2: "Your consultation with Advocate Zahid Hasan is scheduled for 2025-07-22 at 10:00 AM.",
                        notificationTime2: "1 hour ago",
                        notificationTitle3: "New Document Upload",
                        notificationText3: "Your advocate has uploaded a new document for Case #CRN-12345.",
                        notificationTime3: "Yesterday",
                        notificationTitle4: "System Maintenance Alert",
                        notificationText4: "The system will be down for maintenance on 2025-07-25 from 2:00 AM to 4:00 AM.",
                ...
                bn: {
                    ...
                    page: {
                        heading: "বিজ্ঞপ্তি",
                        description: "মামলার আপডেট, অ্যাপয়েন্টমেন্ট এবং সিস্টেম সতর্কতা সম্পর্কে অবগত থাকুন।",
                        notificationCenterHeading: "বিজ্ঞপ্তি কেন্দ্র",
                        notificationTitle1: "নতুন কেস আপডেট: মামলা #CRN-12345",
                        notificationText1: "আপনার মামলার স্থিতি 'তদন্তাধীন' থেকে 'শুনানির জন্য নির্ধারিত' এ পরিবর্তিত হয়েছে।",
                        notificationTime1: "৫ মিনিট আগে",
                        markAsRead: "পঠিত হিসাবে চিহ্নিত করুন",
                        notificationTitle2: "নতুন পরামর্শ অ্যাপয়েন্টমেন্ট",
                        notificationText2: "অ্যাডভোকেট জাহিদ হাসানের সাথে আপনার পরামর্শ 2025-07-22 তারিখে 10:00 AM এ নির্ধারিত হয়েছে।",
                        notificationTime2: "১ ঘন্টা আগে",
                        notificationTitle3: "নতুন নথি আপলোড",
                        notificationText3: "আপনার আইনজীবী মামলা #CRN-12345 এর জন্য একটি নতুন নথি আপলোড করেছেন।",
                        notificationTime3: "গতকাল",
                        notificationTitle4: "সিস্টেম রক্ষণাবেক্ষণ সতর্কতা",
                        notificationText4: "সিস্টেমটি 2025-07-25 তারিখে 2:00 AM থেকে 4:00 AM পর্যন্ত রক্ষণাবেক্ষণের জন্য বন্ধ থাকবে।",
